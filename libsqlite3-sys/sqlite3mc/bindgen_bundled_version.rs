...
unsafe extern "C" {
    pub fn sqlite3mc_cipher_index(cipherName: *const ::core::ffi::c_char) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    pub fn sqlite3mc_cipher_name(cipherIndex: ::core::ffi::c_int) -> *const ::core::ffi::c_char;
}
unsafe extern "C" {
...
pub type AllocateCipher_t =
    ::core::option::Option<unsafe extern "C" fn(db: *mut sqlite3) -> *mut ::core::ffi::c_void>;
pub type FreeCipher_t =
    ::core::option::Option<unsafe extern "C" fn(cipher: *mut ::core::ffi::c_void)>;
pub type CloneCipher_t = ::core::option::Option<
    unsafe extern "C" fn(cipherTo: *mut ::core::ffi::c_void, cipherFrom: *mut ::core::ffi::c_void),
>;
